/**
 ...
 public class SimulationView extends JFrame
 {
	...
	private ImageIcon myCustomer1;
	private ImageIcon myFloor;
	...
	private JComboBox<Integer> myNumberOfQueuesEntered;
 	...
 	public SimulationView(SimulationController controller)
 	{
 		...
 		myCustomer1 = new ImageIcon("src/images/Bear.gif");
 		myFloor = new ImageIcon("src/images/Floor.jpg");
	...
	public void setLines(int l, int size)
	{
		...
		switch(size)
		{
			...
			case 1: myLines[7][l].setIcon(null);
					...
					myLines[1][l].setIcon(null);
					break;
			case 2: myLines[7][l].setIcon(myCustomer1);
					myLines[6][l].setIcon(null);
					myLines[5][l].setIcon(null);
					myLines[4][l].setIcon(null);
					myLines[3][l].setIcon(null);
					...
					myLines[1][l].setIcon(null);
					break;
			case 3: myLines[7][l].setIcon(myCustomer1);
					myLines[6][l].setIcon(myCustomer1);
					myLines[5][l].setIcon(null);
					myLines[4][l].setIcon(null);
					myLines[3][l].setIcon(null);
					myLines[2][l].setIcon(null);
					myLines[1][l].setIcon(null);
					break;
			case 4: myLines[7][l].setIcon(myCustomer1);
					myLines[6][l].setIcon(myCustomer1);
					myLines[5][l].setIcon(myCustomer1);
					myLines[4][l].setIcon(null);
					myLines[3][l].setIcon(null);
					myLines[2][l].setIcon(null);
					myLines[1][l].setIcon(null);
					break;
			case 5: myLines[7][l].setIcon(myCustomer1);
					myLines[6][l].setIcon(myCustomer1);
					myLines[5][l].setIcon(myCustomer1);
					myLines[4][l].setIcon(myCustomer1);
					myLines[3][l].setIcon(null);
					myLines[2][l].setIcon(null);
					myLines[1][l].setIcon(null);
					break;
			case 6: myLines[7][l].setIcon(myCustomer1);
					myLines[6][l].setIcon(myCustomer1);
					myLines[5][l].setIcon(myCustomer1);
					myLines[4][l].setIcon(myCustomer1);
					myLines[3][l].setIcon(myCustomer1);
					myLines[2][l].setIcon(null);
					myLines[1][l].setIcon(null);
					break;	
			case 7: myLines[7][l].setIcon(myCustomer1);
					myLines[6][l].setIcon(myCustomer1);
					myLines[5][l].setIcon(myCustomer1);
					myLines[4][l].setIcon(myCustomer1);
					myLines[3][l].setIcon(myCustomer1);
					myLines[2][l].setIcon(myCustomer1);
					myLines[1][l].setIcon(null);
					break;
			case 8: myLines[7][l].setIcon(myCustomer1);
					myLines[6][l].setIcon(myCustomer1);
					myLines[5][l].setIcon(myCustomer1);
					myLines[4][l].setIcon(myCustomer1);
					myLines[3][l].setIcon(myCustomer1);
					myLines[2][l].setIcon(myCustomer1);
					myLines[1][l].setIcon(myCustomer1);
					break;	
			default: myLines[7][l].setIcon(myCustomer1);
					myLines[6][l].setIcon(myCustomer1);
					myLines[5][l].setIcon(myCustomer1);
					myLines[4][l].setIcon(myCustomer1);
					myLines[3][l].setIcon(myCustomer1);
