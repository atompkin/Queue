...
public class UniformCustomerGenerator extends CustomerGenerator
{
	...
	public UniformCustomerGenerator(int maxTimeBetweenCustomers, int totalNumberOfCustomers, ServiceQueueManager serviceQueueManager) 
	{
		super(maxTimeBetweenCustomers,totalNumberOfCustomers,serviceQueueManager);
